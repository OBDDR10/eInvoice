        ...
        <div style="margin-top: 50px; margin-bottom: 25px;">
          <table style="width: 100%;">
            <tr style="font-size: 14px; height: 20px;">
              ...
              <th style="width: 2%;"></th>
              <th style="width: 12%; text-align: right;"><p style="margin: 0;font-weight: bold;">Quotation</p></th>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td style="text-align: right;"><p style="margin: 0;">Quotation No </p></td>
              <td style="text-align: right;"><p style="margin: 0;">:</p></td>
              <td style="text-align: right;"><p style="margin: 0;">{{ $data->quotation_no }}</p></td>
            </tr>
            <tr>
