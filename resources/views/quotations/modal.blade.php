  ...
  <div class="col-md-8">
    <div class="mb-3">
      <div class="d-flex justify-content-end" style="margin-top: 0!important; margin-bottom: 0!important;">
        <button id="add_quotation_button" type="button" class="btn btn-primary" onclick="AddRow()" 
      ...
      <div class="table-responsive p-0 hide-scrollbar">
        <table class="table quotation-table align-items-center justify-content-center mb-0">
          <thead>
